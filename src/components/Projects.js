...
const  Projects = () => {
    ...
    return (<section className="projects">
          ...
          <p className="projects-header-p">
             ...
             <br /> <br /> I have managed to work on the following projects:</p>
          <div className="project-items">
              <div className="item">
                <img src={cocktails} alt="cocktail" />
                <h1 className="project-p-h1">Cocktail Joint</h1>
                <p className="project-p-h1">
                    Cocktail joint is a project made with ReactJs. This site uses an external API to fetch data. Users are able to search different types of cocktails through the search bar,
                    as well as get detailed information on cocktails ingredients
                </p>
              ...
              <div className="item">
                ...
                <p className="project-p-h1">
                    This is a JavaScript paractice project, 
                    that i built while learning JavaScript programming language
              ...
              <div className="item">
                 ...
                 <p className="project-p-h1">
                     A Hotel Menu project that allows users to search for different meals to order, 
                     depending on time,that is; braekfast,lunch as well as shakes
                </p >
